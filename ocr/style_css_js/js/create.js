...
document.head.innerHTML += '<link rel="stylesheet" href="../style_css_js/css/create.css">'
document.head.innerHTML += '<link rel="stylesheet" href="../style_css_js/css/total.css">'
// document.write('<script type="text/javascript" src="../style_css_js/js/total.js "></script>')
...
Submit.onclick = function(){
    window.location = 'task_details.html'
}